...
?>
            <tr>
                ...
                <td>
                    <?php
                        $cus = $get_revenue->fetch_details_group('customers', 'customer', 'customer_id', $detail->customer);
                        echo $cus->customer;
                    ?>
                </td>
                ...
                <td>
                 ...
                 <td><button style="border-radius:10px; background:#c4c4c4; color:#000; padding:4px; box-shadow:1px 1px 1px #222; border:1px solid #fff;" title="Print receipt" onclick="printReceipt('<?php echo $detail->invoice?>');"><i class="fas fa-print"></i> Print</button></td>
            </tr>
            <?php $n++; }?>
        </tbody>
    </table>
