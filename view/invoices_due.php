        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php
                        //get loan details
                        $lns = $get_customer->fetch_details_cond('loan_applications', 'loan_id', $detail->loan);
                        foreach($lns as $ln){
                            $product = $ln->product;
                            $asset = $ln->asset;
                        }
                        if($asset == 0){
                            //get product name
                            $prds = $get_customer->fetch_details_group('loan_products', 'product', 'product_id', $product);
                            echo $prds->product;
                        }else{
                            //get asset name
                            $prds = $get_customer->fetch_details_group('items', 'item_name', 'item_id', $asset);
                            echo $prds->item_name;
                        }
                    ?>
                </td>
