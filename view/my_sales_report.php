...
<div id="revenueReport" class="displays management" style="margin:0!important;width:100%!important">
    <div class="select_date">
        ...
        <section>    
            ...
            <button type="submit" name="search_date" id="search_date" onclick="search('search_mysales_report.php')">Search <i class="fas fa-search"></i></button>
        </section>
    </div>
<div class="displays allResults new_data" id="revenue_report">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_date2Cond('sales', 'date(post_date)', 'sales_status', 2, 'posted_by', $user);
    ...
    <?php
        ...
        $cashs = $get_cash->fetch_sum_curdate2Con('payments', 'amount_due', 'post_date', 'payment_mode', 'Cash', 'posted_by', $user);
        ...
        //get pos
        $get_pos = new selects();
        $poss = $get_pos->fetch_sum_curdate2Con('payments', 'amount_due', 'post_date', 'payment_mode', 'POS', 'posted_by', $user);
        ...
        $trfs = $get_transfer->fetch_sum_curdate2Con('payments', 'amount_due', 'post_date', 'payment_mode', 'Transfer', 'posted_by', $user);
        ...
        $amounts = $get_total->fetch_sum_curdate2Con('sales', 'total_amount', 'post_date', 'sales_status', 2, 'posted_by', $user);
