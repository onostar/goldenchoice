        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php }else{?>
                    <a style="padding:5px; border-radius:15px;background:var(--tertiaryColor);color:#fff;"href="javascript:void(0)" onclick="showPage('disburse_asset_loan.php?loan=<?php echo $detail->loan_id?>')" title="view Loan details">Disburse <i class="fas fa-hand-holding-dollar"></i></a>
                    <?php }?>
                </td>
            </tr>
